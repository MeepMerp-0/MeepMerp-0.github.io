...
export const SERVICES = [
  ...
  { label: 'React / Next.js', anim: 'driftB', dur: '20s', delay: '4s', x: '70%', y: '14%' },
  { label: 'AI Workflow Automation', anim: 'driftC', dur: '15s', delay: '8s', x: '78%', y: '60%' },
  { label: 'React Native / Expo', anim: 'driftA', dur: '19s', delay: '2s', x: '4%', y: '65%' },
  { label: 'Laravel / Livewire', anim: 'driftB', dur: '13s', delay: '6s', x: '60%', y: '80%' },
  { label: 'Node.js / REST APIs', anim: 'driftC', dur: '22s', delay: '11s', x: '18%', y: '82%' },
  { label: 'Database Design', anim: 'driftA', dur: '16s', delay: '9s', x: '84%', y: '36%' },
  { label: 'Cloud & DevOps', anim: 'driftB', dur: '21s', delay: '3s', x: '5%', y: '44%' },
];
...
export const MARQUEE_LOGOS = [
  ...
  { name: 'SSH', img: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/ssh/ssh-original.svg' },
  { name: 'n8n', img: 'https://raw.githubusercontent.com/n8n-io/n8n/master/packages/editor-ui/src/components/NodeIcon/n8n.svg' },
  ...
  { name: 'OpenAI', img: 'https://unpkg.com/@lobehub/icons-static-svg@latest/icons/openai-color.svg' },
...
export const PROFICIENCY = [
  { label: 'React / Next.js', step: 4 },
  { label: 'React Native / Expo', step: 3 },
  { label: 'Node.js / REST APIs', step: 3 },
...
export const PROJECTS = [
  ...
  },
  {
    ...
    desc: 'Engineered a full-stack web and mobile system for security guard attendance and payroll, cutting processing time from 5–10 days to instant generation.',
  ...
  },
  {
    ...
    desc: 'Prototyped an interactive 360° property tour that improves property browsing convenience through an immersive virtual walkthrough.',
...
export const CONTACT_INFO = [
  { icon: 'mail', label: 'Email', value: 'jason.selerio@gmail.com', href: 'mailto:jason.selerio@gmail.com' },
  { icon: 'phone', label: 'Phone', value: '+971 50 448 2694', href: 'tel:+971504482694' },
  { icon: 'website', label: 'Website', value: 'meepmerp-0.github.io', href: 'https://meepmerp-0.github.io' },
