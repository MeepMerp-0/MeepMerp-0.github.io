...
- **Frontend:** React, Vue.js, Next.js, React Native, Expo, Livewire, TypeScript, JavaScript
- **Backend:** Node.js, Laravel, PHP, Java, C#, RESTful APIs
- **Database:** MySQL, PostgreSQL, SQLite, MariaDB, MongoDB, NoSQL
- **Platform:** Windows, Linux, Windows Subsystem for Linux
- **Tools:** Git, GitHub Actions (CI/CD), VS Code, Microsoft Visual Studio, Vercel, Docker, SSH, n8n, AI tools
- **Cloud & DevOps:** Vercel, Supabase, Docker, GitHub Actions, SSH
- **Artificial Intelligence:** OpenAI, Claude, Codex, Perplexity, n8n, AI Agentic Engineering, Prompt Engineering, MCP
...
* Invited to participate in StartUP Quezon City
...
- `LIGHT_SRC` - Light theme avatar (default: Cloudflare R2 URL)
- `DARK_SRC` - Dark theme avatar (default: Cloudflare R2 URL)
